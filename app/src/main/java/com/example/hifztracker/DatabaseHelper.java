...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public long addStudent(Student student) {
        ...
        long rollNo = db.insert(TABLE_STUDENTS, null, values);
        db.close();
        return rollNo;
    }
    ...
    public List<Student> getAllStudents() {
        ...
        if (cursor.moveToFirst()) {
            do {
                int rollNoIndex = cursor.getColumnIndexOrThrow(COLUMN_ROLL_NO);
                ...
                Student student = new Student(rollNo, name, age, studentClass, sabaq, sabaqi, currentManzil);
    ...
    public boolean isStudentExists(int rollNo) {
        ...
        String query = "SELECT * FROM " + TABLE_STUDENTS + " WHERE " + COLUMN_ROLL_NO + " = " + rollNo;
    ...
    public int updateRecord(int rollNo, String sabaq, String sabaqi, int manzil) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_SABAQ, sabaq);
        values.put(COLUMN_SABAQI, sabaqi);
        values.put(COLUMN_CURRENT_MANZIL, manzil);
        return db.update(TABLE_STUDENTS, values, COLUMN_ROLL_NO + " = ?", new String[]{String.valueOf(rollNo)});
    }
    ...
    public Student getStudent(int rollNo) {
        ...
        if (cursor.moveToFirst()) {
            ...
            student = new Student(rollno, name, age, studentClass, sabaq, sabaqi, currentManzil);
        }
        cursor.close();
        db.close();
        return student;
